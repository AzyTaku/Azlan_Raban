...
import { FaReact, FaNodeJs, FaGitAlt, FaDocker, FaHtml5, FaCss3Alt, FaGithub, FaJava } from 'react-icons/fa';
...
const Tech = () => {
    const [scrollIcons, setScrollIcons] = useState(new Array(20).fill(false));
